...
public class RaymondAguilar_3_2Darray {
    ...
    public static Level2 nlvl = new Level2();
...
static void board() {
    ...
    static void move() {
        ...
        if(movement.contains("nlvl")){
            nlvl.Level2();
        }
        if(hero.herox>enemy1.enemyx){
            enemy1.enemyx++;   
        }
        if(hero.herox<enemy1.enemyx){
            enemy1.enemyx--;
        }
        if(hero.heroy>enemy1.enemyy){
            enemy1.enemyy++;
        }
        if(hero.herox<enemy1.enemyy){
            enemy1.enemyy--;
        }
        if(hero.herox>enemy2.enemy2x){
            enemy2.enemy2x++;
        }
        if(hero.herox<enemy2.enemy2x){
            enemy1.enemyx--;
        }
        if(hero.heroy>enemy2.enemy2y){
            enemy2.enemy2y++;
        }
        if(hero.heroy<enemy2.enemy2y){
            enemy2.enemy2y--;
        }
        if(hero.herox>enemy3.enemy3x){
            enemy3.enemy3x++;
        }
        if(hero.herox<enemy3.enemy3x){
            enemy3.enemy3x--;
        }
        if(hero.heroy>enemy3.enemy3y){
            enemy3.enemy3y++;
        }
        if(hero.heroy<enemy3.enemy3y){
            enemy3.enemy3y--;
         ...
         if(hero.herox==enemy1.enemyx&&hero.heroy==enemy1.enemyy){
    letsplay=false;
    System.out.println("You have fallen into the hands of the O's. You lose.");

            }
          if(hero.herox==enemy2.enemy2x&&hero.heroy==enemy2.enemy2y){
    letsplay=false;
    System.out.println("You have fallen into the hands of the O's. You lose.");

            }
           if(hero.herox==enemy3.enemy3x&&hero.heroy==enemy3.enemy3y){
    letsplay=false;
    System.out.println("You have fallen into the hands of the O's. You lose.");

            }
           if(hero.herox==treasurex&&hero.heroy==treasurey){
...
System.out.println(" \\ \\      / (_)_ __ | |");
 ...
 System.out.println("   \\ V  V / | | | | |_|");
     ...
     nlvl.Level2();        
           ...
           if(hero.herox==treasuretrapx&&hero.heroy==treasuretrapy){
    letsplay=false;
...
System.out.println ("|___/");                                  
           ...
           if(hero.herox==trapx&&hero.heroy==trapy){
    letsplay=false;
